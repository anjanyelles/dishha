<script lang="ts" context="module">
  const isCustomerStory = (story: ISbStoryData): story is ISbStoryData<CustomerStoryStoryblok> => {
    return story.content.component === 'customer-story';
  };
</script>
...
{#if story && isCustomerStory(story)}
