<script lang="ts" context="module">
  const isJobDescriptionPage = (
    story: ISbStoryData
  ): story is ISbStoryData<JobDescriptionStoryblok> => {
    return story.content.component === 'job-description';
  };
</script>
...
<script lang="ts">
  ...
  import type { JobDescriptionStoryblok } from '$types/bloks';
  ...
  export let blok: JobDescriptionStoryblok;
...
{#if story && isJobDescriptionPage(story)}
